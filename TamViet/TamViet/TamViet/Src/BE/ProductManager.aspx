<%@ Page Title="" Language="C#" MasterPageFile="~/Src/BE/_Admin.Master" AutoEventWireup="true" CodeBehind="ProductManager.aspx.cs" Inherits="TamViet.Src.BE.ProductManager" %>
        ...
        <asp:DataGrid runat="server" AutoGenerateColumns="false" ID="dtgProduct" CssClass="grd-stdtable" PageSize="15" ShowHeader="true"
            ...
            <Columns>
                ...
                <asp:TemplateColumn>
                    ...
                    <ItemTemplate>
                        <asp:CheckBox ID="CheckBox1" runat="server" Enabled="false" Checked='<%#(bool)Eval("Active") %>'/>
                    </ItemTemplate>
                </asp:TemplateColumn>
                <asp:TemplateColumn>
